...
/**
 * @method static HtmlString render(mixed $value, string|array|null $format = null, ?string $class = null, ?string $driver = null)
 * @method static HtmlString renderNumberFlow(mixed $value, ?array $format = null, ?string $class = null)
